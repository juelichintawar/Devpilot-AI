...
public class GitHubViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<GitHubUser> userProfile =
            new MutableLiveData<>();

    private final MutableLiveData<String> aiAnalysisResult =
            new MutableLiveData<>();
    ...
    public LiveData<GitHubUser> login(
            String token) {

        isLoading.setValue(true);

        MutableLiveData<GitHubUser> loginResult =
                new MutableLiveData<>();
    ...
    public LiveData<List<GitHubRepo>>
    getRepositories() {

        isLoading.setValue(true);

        MutableLiveData<List<GitHubRepo>> result =
                new MutableLiveData<>();
    ...
    getRepositoryDetails(
        ...
        MutableLiveData<GitHubRepo> result =
                new MutableLiveData<>();
    ...
    public LiveData<List<GitHubCommit>>
    getCommits(
            String owner,
            String repoName) {
        ...
        MutableLiveData<List<GitHubCommit>> result =
                new MutableLiveData<>();
    ...
    public LiveData<List<GitHubBranch>>
    getBranches(
            String owner,
            String repoName) {
        ...
        MutableLiveData<List<GitHubBranch>> result =
                new MutableLiveData<>();
    ...
    public LiveData<List<Map<String, Object>>>
    getIssues(
            String owner,
            String repoName) {
        ...
        MutableLiveData<List<Map<String, Object>>> result =
                new MutableLiveData<>();
    ...
    public LiveData<List<Map<String, Object>>>
    getUserActivity(String username) {
    ...
    private void fetchTree(
        ...
        RetrofitClient
                ...
                .enqueue(
                        new Callback<GitHubTreeResponse>() {

                            @Override
                            public void onResponse(
                                    Call<GitHubTreeResponse> call,
                                    Response<GitHubTreeResponse> response) {

                                if (response.isSuccessful()
                                        && response.body() != null) {

                                    fetchFilesAndAnalyze(
                                            owner,
                                            repoName,
                                            authHeader,
                                            readme,
                                    ...
                                    RetrofitClient
                                            ...
                                            .enqueue(
                                                    new Callback<GitHubTreeResponse>() {
                                                        ...
                                                        public void onResponse(
                                                                Call<GitHubTreeResponse> call,
                                                                Response<GitHubTreeResponse> responseMaster) {

                                                            if (responseMaster.isSuccessful()
                                                                    && responseMaster.body() != null) {
    ...
    private void fetchFilesAndAnalyze(
            String owner,
            String repoName,
            String authHeader,
            String readme,
        ...
        final StringBuilder contextBuilder =
                new StringBuilder();
        ...
        List<GitHubTreeResponse.TreeEntry> entries =
                treeResponse.tree;

        int maxFiles = 5;

        AtomicInteger filesFetched =
                new AtomicInteger(0);
                        ...
                        .enqueue(
                                new Callback<ResponseBody>() {
                                    ...
                                    public void onResponse(
                                        ...
                                        if (filesFetched.incrementAndGet()
                                                == totalToFetch) {
    ...
    private void callGeminiForAnalysis(
            String context,
            String owner,
            String repoName) {

        String prompt =
                "Review this GitHub repository based on "
                        + "the provided README and source code snippets. "
                        + "Provide a structured review including:\n"
                        + "1. Code Quality Score (0-100)\n"
                        + "2. Architecture Suggestions\n"
                        + "3. Security Issues\n"
                        + "4. Performance Improvements\n"
                        + "5. Resume-worthy project summary "
                        + "(highlighting key skills used)\n\n"
                        + "CONTEXT:\n"
                        + context;

        Log.d(
                TAG,
                "Sending GitHub repository analysis to Firebase AI Logic"
        );
        ...
        geminiAIService.generateResponse(
                ...
                new GeminiAIService.AIResponseCallback() {
                    ...
                    @Override
                    public void onError(Throwable errorThrowable) {
